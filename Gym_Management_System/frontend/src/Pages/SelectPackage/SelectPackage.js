        ...
        <div className="col-md-6 mb-3">
          <div className="card" style={{ backgroundColor: "rgba(211, 211, 211, 0.5)" }}>
            <div className="card-body d-flex flex-column justify-content-between text-white text-center" style={{ height: "500px" }}>
              ...
              <button onClick={() => navigate('/promotion')} className="btn btn-light text-dark mt-3" style={{ alignSelf: "center", padding: "10px 40px" }}>Buy Now</button>
            </div>
          </div>
        </div>
        <div className="col-md-6 mb-3">
          <div className="card" style={{ backgroundColor: "rgba(211, 211, 211, 0.5)" }}>
            <div className="card-body d-flex flex-column justify-content-between text-white text-center" style={{ height: "500px" }}>
              ...
              <button onClick={() => navigate('/standard')} className="btn btn-light text-dark mt-3" style={{ alignSelf: "center", padding: "10px 40px" }}>Buy Now</button>
            </div>
          </div>
        </div>
      </div>
